...
class Player():
    ...
    def draw(self):
        ...
        draw.line(mw, (0, 0, 255), (int(self.x), int(self.y)),
            (int(self.x + self.length * cos(DtoR(self.angle))), int(self.y + self.length * sin(DtoR(self.angle)))), 5)
...
if __name__ == '__main__':
    ...
    player2 = Player('2', 1300, 450, 180, 70, K_l, K_QUOTEDBL, K_p, K_SEMICOLON, K_RSHIFT, K_RCTRL)
